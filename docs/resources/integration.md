...
- `aws_s3_spec` (Attributes) The specifications of an AWS S3 integration for exporting database query and audit logs. You can use the same integration with ybm_db_query_logging and ybm_db_audit_logging resources. See below for the [nested schema](#nestedatt--aws_s3_spec).
